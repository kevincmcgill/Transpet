...
public class angrypoodle extends AppCompatActivity {
    Bundle bundle;
    Intent intent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_angrypoodle);
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent mainIntent = new Intent( angrypoodle.this,  loadingpoodle.class);
