...
public class happycorgi extends AppCompatActivity {
    Bundle bundle;
    Intent intent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_happycorgi);
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent mainIntent = new Intent( happycorgi.this,  loadingcorgi.class);
