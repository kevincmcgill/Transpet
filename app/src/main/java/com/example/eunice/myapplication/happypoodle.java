...
public class happypoodle extends AppCompatActivity {
    Bundle bundle;
    Intent intent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_happypoodle);
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent mainIntent = new Intent( happypoodle.this,  loadingpoodle.class);
